        ...
        <Section>
            <div className="pl-5">
                ...
                <ol className="parenthetical-list-style pt-[2.5vh] pb-[2.5vh]">
                    ...
                    <li>see our examples on github, such as <Link href="https://github.com/dylsteck/farcasterkit/tree/main/examples/starter"><span className="text-fcPurple">examples/starter</span></Link> and <Link href="https://github.com/dylsteck/casterscan"><span className="text-fcPurple">casterscan</span></Link></li>
